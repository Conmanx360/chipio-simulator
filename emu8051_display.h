...
const struct popup_win_info popup_defs[NUM_OF_POPUPS] = {
	...
	{ .title = "Verb Input",
	  ...
	  .field_info = {
	     ...
	     { .field_label = "[ ]",
	       .field_id    = VERB_RUN_TO_EXIT_SWITCH,
	       .button_id   = BUTTON_TOGGLE_VERB_RUN_TO_EXIT,
	     ...
	     { .field_label = "Run to interrupt exit.",
	       .field_id    = VERB_RUN_TO_EXIT_LABEL,
	       .in_type     = INPUT_NONE,
	       .off_flags   = O_ACTIVE,
	       .field_back  = A_NORMAL,
	       .fore_color  = PAIR_RED,
	...
	{ .title = "Log File Setup",
	  .height = 12,
	  .width = AUTO_ADJUST,
	  .num_of_fields = LOG_ENABLE_FIELD_CNT,
	  .num_of_inputs = 1,
	  ...
	  .field_info = {
	     ...
	     { .field_label = "[ ]",
	       .field_id    = LOG_ENABLE_SAVE_SWITCH,
	       .button_id   = BUTTON_TOGGLE_SAVE_LOG,
	       .in_type     = INPUT_TOGGLE,
	       .off_flags   = O_AUTOSKIP,
	       .field_back  = A_NORMAL,
	       .fore_color  = PAIR_WHITE,
	     ...
	     { .field_label = "Create save file at start.",
	       .field_id    = LOG_ENABLE_SAVE_LABEL,
	       .in_type     = INPUT_NONE,
	       .off_flags   = O_ACTIVE,
	       .field_back  = A_NORMAL,
	       .fore_color  = PAIR_RED,
